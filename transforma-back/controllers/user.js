...
function signUp(req, res) {
	...
	const { fullName, name, lastname, email, rut, enterprise, position, phone, country, adress, other, sector, category, subCategory } = req.body;
	...
	// 			user.other = other;
	// 		}
	// 		if (verifyAccreditation.sector) {
	// 			user.sector = sector;
	// 			console.log('Entro al sector')
	// 		}
	// 		if (verifyAccreditation.category) {
	// 			user.category = category;
	// 			console.log('Entro al categoria')
	// 		}
	// 		if (verifyAccreditation.subCategory) {
	// 			user.subCategory = subCategory;
	// 			console.log('Entro al sub')
	// 		}
